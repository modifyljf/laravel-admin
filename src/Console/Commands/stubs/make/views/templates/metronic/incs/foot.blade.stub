...
<!--begin::Base Scripts -->
<script src="{{ asset("templates/metronic/default/dist/default/assets/vendors/base/vendors.bundle.js") }}"
        type="text/javascript"
>
</script>
<script src="{{ asset("templates/metronic/default/dist/default/assets/demo/default/base/scripts.bundle.js") }}"
        type="text/javascript"
>
</script>
<!--end::Base Scripts -->
